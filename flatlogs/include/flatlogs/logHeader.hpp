...
public:
   ...
   static int logLevel( bufferPtrT & logBuffer, ///< [in/out] a shared_ptr\<char\> containing a raw log entry buffer.
                        const logPrio & lvl   ///< [in] the new log level.
                      );
   ...
   /**
     ...
     * \ingroup logbuff
     */
   static logPrio logLevel( bufferPtrT & logBuffer /**< [in] a shared_ptr\<char\> containing a raw log entry buffer.*/);
   ...
   /**
     ...
     * \ingroup logbuff
     */
   static logPrio logLevel( char * logBuffer /**< [in] a pointer to a raw log entry buffer.*/);
   ...
   /** Convenience wrapper for the other extraction functions.
     ...
     * \ingroup logbuff
     */
   static int extractBasicLog( logPrio & lvl,        ///< [out] The log level
...
{
   reinterpret_cast<internal_logHeader *>(logBuffer.get())->m_logLevel = static_cast<logPrioT>(lvl);

   return 0;
}

inline
logPrio logHeader::logLevel( bufferPtrT & logBuffer)
{
...
inline
logPrio logHeader::logLevel( char * logBuffer)
{
   return static_cast<logPrio>(reinterpret_cast<internal_logHeader *>(logBuffer)->m_logLevel);
}
...
inline
int logHeader::extractBasicLog( logPrio & lvl,
                                eventCodeT & ec,
                                timespecX & ts,
                                msgLenT & len,
