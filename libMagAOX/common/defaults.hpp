...
#ifndef MAGAOX_default_driverRelPath
   /// The default relative path to the INDI drivers
   /**
     */
   #define MAGAOX_default_driverRelPath "drivers"
#endif

#ifndef MAGAOX_default_driverFIFORelPath
   /// The default relative path to the INDI driver FIFOs
   /**
     */
   #define MAGAOX_default_driverFIFORelPath "drivers/fifos"
#endif
