/** \file old_telem_fxngen.hpp
  * \brief The MagAO-X logger old_telem_fxngen log type.
  ...
  */
#ifndef logger_types_old_telem_fxngen_hpp
#define logger_types_old_telem_fxngen_hpp

#include "old_telem_fxngen_generated.h"
...
/** \ingroup logger_types
  */
struct old_telem_fxngen : public flatbuffer_log
{
   ///The event code
   ...
   struct messageT : public fbMessage
   {
              ...
              )
      {
         ...
         auto fp = CreateOldTelem_fxngen_fb(builder, C1outp, C1freq, C1vpp, C1ofst, C1phse, C1wdth, _C1wvtp, C2outp, C2freq, C2vpp, C2ofst, C2phse, C2wdth,  _C2wvtp, C1sync, C2sync);
         builder.Finish(fp);
                     ...
                     )
   {
      ...
      return VerifyOldTelem_fxngen_fbBuffer(verifier);
   }
                               ...
                               )
   {
      ...
      auto fbs = GetOldTelem_fxngen_fb(msgBuffer);
   ...
   {
      return makeJSON(msgBuffer, len, OldTelem_fxngen_fbTypeTable());
   }
...
#endif //logger_types_old_telem_fxngen_hpp
