/** \file windsoccAppImportProbe.cpp
 * \brief The MagAO-X windsoccAppImportProbe main program source file.
 *
 * \ingroup windsoccRT_files
 */

#include "windsoccAppImportProbe.hpp"
...
windsoccAppImportProbe::windsoccAppImportProbe() : MagAOXApp(MAGAOX_CURRENT_SHA1, MAGAOX_REPO_MODIFIED)
{
   return;
}

void windsoccAppImportProbe::traceDebug(const std::string &msg)
{
   if(!m_debugTrace)
   {
      return;
   ...
   log<text_log>("windsoccAppImportProbe trace: " + msg, logPrio::LOG_NOTICE);
}

void windsoccAppImportProbe::setupConfig()
{
   ...
   config.add("windsocc.pythonModule",
              ...
              false,
              "string",
              "Python module imported by the MagAO-X app probe.");
   ...
   config.add("windsocc.debugTrace",
              ...
              false,
              "bool",
              "Enable trace lines (LOG_NOTICE) for the MagAO-X app import probe. Default is false.");
...
int windsoccAppImportProbe::loadConfigImpl(mx::app::appConfigurator &_config)
{
   ...
   if(m_debugTrace && m_debugTraceLoggerDebug)
   {
      ...
      log<text_log>("windsoccAppImportProbe: minimum log level set to DEBUG "
...
void windsoccAppImportProbe::loadConfig()
{
   loadConfigImpl(config);
}

int windsoccAppImportProbe::initializePythonImport()
{
...
void windsoccAppImportProbe::shutdownPythonImport()
{
...
int windsoccAppImportProbe::appStartup()
{
   ...
   traceDebug("appStartup: import completed; requesting shutdown before INDI startup");
...
int windsoccAppImportProbe::appLogic()
{
   return 0;
}

int windsoccAppImportProbe::appShutdown()
{
...
/// \brief Entry point for the windsoccAppImportProbe MagAO-X application.
int main(int argc, char **argv)
{
   MagAOX::app::windsoccAppImportProbe xapp;
