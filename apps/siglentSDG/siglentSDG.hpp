...
private:
   std::vector<double> m_maxAmp = {5.0,   0.71,  0.83, 0.88, 1.05, 1.15, 3.45}; //1.5,     1.2,     1.1     };
   std::vector<double> m_maxFreq = {0.0, 100.0,   150,  200,  250,  300, 1000}; //2999.99, 3499.99, 3500.01};
