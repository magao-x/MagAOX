...
inline int
extrapClosedLoopOlEstimateMethodFromElement(const std::string &element) {
...
struct psdShmimT {
  static std::string configSection() { return "psdShmim"; };

  static std::string indiPrefix() { return "psd"; };
};

struct freqShmimT {
  static std::string configSection() { return "freqShmim"; };

  static std::string indiPrefix() { return "freq"; };
};

struct gainFactShmimT {
  static std::string configSection() { return "gainFactShmim"; };

  static std::string indiPrefix() { return "gainFact"; };
};

struct multFactShmimT {
  static std::string configSection() { return "multFactShmim"; };

  static std::string indiPrefix() { return "multFact"; };
};

struct pcGainFactShmimT {
  static std::string configSection() { return "pcGainFactShmim"; };

  static std::string indiPrefix() { return "pcGainFact"; };
};

struct pcMultFactShmimT {
  static std::string configSection() { return "pcMultFactShmim"; };

  static std::string indiPrefix() { return "pcMultFact"; };
};

struct numpccoeffShmimT {
  static std::string configSection() { return "numpccoeffShmim"; };

  static std::string indiPrefix() { return "numpccoeff"; };
};

struct acoeffShmimT {
  static std::string configSection() { return "acoeffShmim"; };

  static std::string indiPrefix() { return "acoeff"; };
};

struct bcoeffShmimT {
  static std::string configSection() { return "bcoeffShmim"; };

  static std::string indiPrefix() { return "bcoeff"; };
};

struct gainCalShmimT {
  static std::string configSection() { return "gainCalShmim"; };

  static std::string indiPrefix() { return "gainCal"; };
};

struct gainCalFactShmimT {
  static std::string configSection() { return "gainCalFactShmim"; };

  static std::string indiPrefix() { return "gainCalFact"; };
};

struct tauShmimT {
  static std::string configSection() { return "tauShmim"; };

  static std::string indiPrefix() { return "tau"; };
};

struct noiseShmimT {
  static std::string configSection() { return "noiseShmim"; };

  static std::string indiPrefix() { return "noise"; };
};

struct wfsavgShmimT {
  static std::string configSection() { return "wfsavgShmim"; };

  static std::string indiPrefix() { return "wfsavg"; };
};

struct wfsmaskShmimT {
  static std::string configSection() { return "wfsmaskShmim"; };

  static std::string indiPrefix() { return "wfsmask"; };
};
...
public:
  ...
  typedef dev::shmimMonitor<modalGainOpt, pcGainFactShmimT>
      pcGainFactShmimMonitorT;
  typedef dev::shmimMonitor<modalGainOpt, pcMultFactShmimT>
      pcMultFactShmimMonitorT;
  typedef dev::shmimMonitor<modalGainOpt, numpccoeffShmimT>
  ...
  typedef dev::shmimMonitor<modalGainOpt, gainCalFactShmimT>
...
protected:
  ...
  std::string m_psdDevice{
      "hopsds"}; /**< The INDI device name of the PSD calculator.  Defaults to
  ...
  bool m_autoUpdate{
      false}; ///< Flag controlling whether gains are automatically updated
  bool m_opticalGainUpdate{false}; ///< Flag controlling whether optical gain is
                                   ///< automatically updated;

  float m_gainGain{
      0.1}; ///< The gain to use for closed-loop gain updates.  Default is 0.1.
  processPsdProcessorT::processModelConfig
      m_extrapConfig; ///< Configuration of the OL PSD extrapolation model.
  ...
  int m_extrapOL{
      c_olProcessNone}; ///< Which extrapolation method to use for the OL PSD.
  int m_extrapNoiseEstimateDomain{
      c_extrapNoiseEstimateOpenLoop}; ///< Where to estimate the modal noise
                                      ///< floor.
  int m_extrapNoiseEstimateRange{
      c_extrapNoiseEstimateHighFreq}; ///< Which PSD end to use for the noise
                                      ///< fit.
  int m_extrapNoiseEstimateStatistic{
      c_extrapNoiseEstimatePercentile}; ///< How the selected PSD bins are
                                        ///< summarized into a noise floor.
  int m_extrapClosedLoopOlEstimateMethod{
      c_extrapClosedLoopOlEstimateEtfOnly}; ///< Which CL-to-OL reconstruction
                                            ///< to use.
  int m_extrapPowerLawCrossoverMode{
      c_extrapPowerLawCrossoverManual}; ///< How the power-law match/cutoff
  ...
  bool m_freqUpdated{
      true}; /**< Tracks if the frequency scale has updated, which necessitates
  ...
  mx::improc::eigenImage<float>
      m_clXferCurrent; ///< Published current closed-loop error transfer
                       ///< function.
  mx::improc::eigenImage<float>
      m_clNtfCurrent; ///< Published current closed-loop noise transfer
                      ///< function.
  mx::improc::eigenImage<float>
      m_clXferSI; ///< Published simple-integrator closed-loop error transfer
                  ///< function.
  mx::improc::eigenImage<float>
      m_clNtfSI; ///< Published simple-integrator closed-loop noise transfer
                 ///< function.
  mx::improc::eigenImage<float>
      m_clXferLP; ///< Published predictive closed-loop error transfer function.
  mx::improc::eigenImage<float>
      m_clNtfLP; ///< Published predictive closed-loop noise transfer function.
  ...
  std::vector<float>
      m_gmaxSI; ///< The previously calculated maximum gains for SI.
  ...
  std::vector<float>
      m_gmaxLP; ///< The previously calculated maximum gains for LP.
  ...
  std::vector<uint32_t>
      m_Na; // The latest user specified number of a coefficients

  std::vector<uint32_t> m_NaCurrent; // The current number of a coefficients

  std::vector<uint32_t>
      m_Nb; // The latest user specified number of b coefficients
  ...
  std::vector<int>
      m_regCounter; ///< Counters to track when this mode was last regularized

  std::vector<float>
      m_regScale; ///< The regularization scale factors for each mode
  ...
  IMAGE *m_smoothOlPSDStream{
      nullptr}; ///< The ImageStreamIO shared memory buffer to publish the
                ///< smoothed OL PSDs
  ...
  void destroyImageStream(
      IMAGE *&stream /**< [in.out] stream pointer to destroy and clear */);

  /// Allocate and create an owned ImageStreamIO output stream.
  int createImageStream(
      IMAGE *&stream, /**< [in.out] stream pointer to allocate and create */
  ...
  /// optimization state.
  void writePublishedGainArrays(
      float *currentData, /**< [out] current optimal-gain stream buffer */
  ...
  void writePublishedPredictorArrays(
      float *pcGainData, /**< [in.out] PC gain-factor stream buffer */
  ...
  int countEnabledGainFactors(
      const std::vector<float> &gainFacts /**< [in] gain factors to inspect */)
      const;

  /// Update `m_modesOn` when a changed gain-factor stream matches the active
  /// control path.
  void updateAppliedModeCount(
      const std::vector<float>
          &gainFacts,    /**< [in] gain factors from the changed stream */
  ...
  bool applyMultiplierUpdate(
      std::vector<float> &multFacts, /**< [in.out] stored multiplier factors to
                                        resize and update */
  ...
  bool applyFrequencyUpdate(
      const float *incoming, /**< [in] incoming frequency frame */
...
public:
  ...
  int processImage(
      void *curr_src,   ///< [in] pointer to the start of the current frame
      const psdShmimT & ///< [in] tag to differentiate shmimMonitor parents.
  );
  ...
  int allocate(const gainFactShmimT
                   & ///< [in] tag to differentiate shmimMonitor parents.
  );

  int processImage(
      void *curr_src, ///< [in] pointer to the start of the current frame
      const gainFactShmimT
          & ///< [in] tag to differentiate shmimMonitor parents.
  );
...
protected:
  ...
  bool m_goptThreadInit{
      true}; ///< Initialization flag for the gain optimization thread.
  ...
  bool m_goptSemaphoreInit{
      false}; ///< Tracks whether the gain optimization semaphore needs cleanup.
...
public:
  ...
  INDI_NEWCALLBACK_DECL(modalGainOpt,
...
void modalGainOpt::setupConfig() {
  config.add(
      "loop.number", "", "loop.number", argType::Required, "loop", "number",
      false, "int",
      "The number of the loop. Used to set shmim names, as in aolN_mgainfact.");

  config.add("loop.name", "", "loop.name", argType::Required, "loop", "name",
             false, "string", "The name of the loop control INDI device name.");

  config.add("loop.psdDev", "", "loop.psdDev", argType::Required, "loop",
             "psdDev", false, "string",
             "The INDI device name of the PSD calculator.  Defaults to "
             "aolN_modevalPSDs where N is loop.number.");

  config.add("loop.autoUpdate", "", "loop.autoUpdate", argType::Required,
             "loop", "autoUpdate", false, "bool",
             "Flag controlling whether the gains are auto updated.  Also "
             "settable via INDI.");

  config.add("loop.gainGain", "", "loop.gainGain", argType::Required, "loop",
             "gainGain", false, "float",
             "The gain to use for closed-loop gain updates.  Default is 0.1");

  config.add("extrapolation.method", "", "extrapolation.method",
             argType::Required, "extrapolation", "method", false, "string",
             "The OL PSD extrapolation method: none, legacy, power_law_only, "
             "or moffat_peaks.");

  config.add("extrapolation.noiseEstimateDomain", "",
             "extrapolation.noiseEstimateDomain", argType::Required,
             "extrapolation", "noiseEstimateDomain", false, "string",
             "Where to estimate the flat noise floor: open_loop or "
             "closed_loop_pre_xfer.");

  config.add("extrapolation.noiseEstimateRange", "",
             "extrapolation.noiseEstimateRange", argType::Required,
             "extrapolation", "noiseEstimateRange", false, "string",
             "Which end of the PSD is used for noise estimation: high_freq or "
             "low_freq.");

  config.add("extrapolation.noiseEstimateStatistic", "",
             "extrapolation.noiseEstimateStatistic", argType::Required,
             "extrapolation", "noiseEstimateStatistic", false, "string",
             "How to summarize the selected noise-estimation bins: percentile "
             "or minimum.");

  config.add("extrapolation.noiseEstimateLowFreqMaxHz", "",
             "extrapolation.noiseEstimateLowFreqMaxHz", argType::Required,
             "extrapolation", "noiseEstimateLowFreqMaxHz", false, "float",
  ...
  config.add("extrapolation.closedLoopOlEstimateMethod", "",
             "extrapolation.closedLoopOlEstimateMethod", argType::Required,
             "extrapolation", "closedLoopOlEstimateMethod", false, "string",
             "How to reconstruct OL PSD from CL PSD: etf_only or ntf_aware.");

  config.add("extrapolation.powerLawIndex", "", "extrapolation.powerLawIndex",
             argType::Required, "extrapolation", "powerLawIndex", false,
             "float", "The power-law exponent a in the 1/f^a continuum model.");

  config.add("extrapolation.powerLawNormFreq", "",
             "extrapolation.powerLawNormFreq", argType::Required,
             "extrapolation", "powerLawNormFreq", false, "float",
             "The power-law normalization frequency in Hz. Set to 0 to use the "
             "first positive bin.");

  config.add("extrapolation.powerLawMatchFreq", "",
             "extrapolation.powerLawMatchFreq", argType::Required,
             "extrapolation", "powerLawMatchFreq", false, "float",
  ...
  config.add("extrapolation.powerLawMatchFallbackWindowHz", "",
             "extrapolation.powerLawMatchFallbackWindowHz", argType::Required,
             "extrapolation", "powerLawMatchFallbackWindowHz", false, "float",
  ...
  config.add("extrapolation.powerLawCrossoverMode", "",
             "extrapolation.powerLawCrossoverMode", argType::Required,
             "extrapolation", "powerLawCrossoverMode", false, "string",
  ...
  config.add("extrapolation.powerLawAutoSmoothWidthHz", "",
             "extrapolation.powerLawAutoSmoothWidthHz", argType::Required,
             "extrapolation", "powerLawAutoSmoothWidthHz", false, "float",
             "Median-smoothing width in Hz used when auto power-law crossover "
             "selection is enabled.");

  config.add("extrapolation.fitPowerLawIndex", "",
             "extrapolation.fitPowerLawIndex", argType::Required,
             "extrapolation", "fitPowerLawIndex", false, "bool",
  ...
  config.add("extrapolation.powerLawOnlyAboveFreq", "",
             "extrapolation.powerLawOnlyAboveFreq", argType::Required,
             "extrapolation", "powerLawOnlyAboveFreq", false, "float",
             "Above this frequency in Hz, force the extrapolation to be "
             "power-law only.");

  config.add("extrapolation.powerLawFitIncludesMatchPoint", "",
             "extrapolation.powerLawFitIncludesMatchPoint", argType::Required,
             "extrapolation", "powerLawFitIncludesMatchPoint", false, "bool",
  ...
  config.add("extrapolation.powerLawFitMinFreqHz", "",
             "extrapolation.powerLawFitMinFreqHz", argType::Required,
             "extrapolation", "powerLawFitMinFreqHz", false, "float",
             "The low edge in Hz of the power-law exponent fit range.");

  config.add("extrapolation.powerLawFitMaxFreqHz", "",
             "extrapolation.powerLawFitMaxFreqHz", argType::Required,
             "extrapolation", "powerLawFitMaxFreqHz", false, "float",
             "The high edge in Hz of the power-law exponent fit range.");

  config.add(
      "extrapolation.powerLawFitBinWidthHz", "",
      "extrapolation.powerLawFitBinWidthHz", argType::Required, "extrapolation",
      "powerLawFitBinWidthHz", false, "float",
      "The width in Hz of the median bins used in the power-law exponent fit.");

  config.add("extrapolation.powerLawBlendBins", "",
             "extrapolation.powerLawBlendBins", argType::Required,
             "extrapolation", "powerLawBlendBins", false, "int",
  ...
  config.add("extrapolation.peakDetectWidthHz", "",
             "extrapolation.peakDetectWidthHz", argType::Required,
             "extrapolation", "peakDetectWidthHz", false, "float",
             "The wide smoothing width in Hz used for peak detection.");

  config.add("extrapolation.peakDetectFactor", "",
             "extrapolation.peakDetectFactor", argType::Required,
             "extrapolation", "peakDetectFactor", false, "float",
             "The factor above the smoothed PSD required for a strong peak "
             "detection.");

  config.add("extrapolation.peakDetectBroadFactor", "",
             "extrapolation.peakDetectBroadFactor", argType::Required,
             "extrapolation", "peakDetectBroadFactor", false, "float",
             "The lower factor above the smoothed PSD used for broad-peak "
             "candidates.");

  config.add("extrapolation.peakDetectMinWidthLog", "",
             "extrapolation.peakDetectMinWidthLog", argType::Required,
             "extrapolation", "peakDetectMinWidthLog", false, "float",
             "The minimum accepted broad-peak width in log-frequency.");

  config.add(
      "extrapolation.peakDetectPasses", "", "extrapolation.peakDetectPasses",
      argType::Required, "extrapolation", "peakDetectPasses", false, "int",
      "The number of iterative subtract-and-redetect peak-detection passes.");

  config.add(
      "extrapolation.peakMoffatBeta", "", "extrapolation.peakMoffatBeta",
      argType::Required, "extrapolation", "peakMoffatBeta", false, "float",
      "The minimum Moffat beta used when synthesizing extrapolated peaks.");

  config.add(
      "extrapolation.dropoutGapFactor", "", "extrapolation.dropoutGapFactor",
      argType::Required, "extrapolation", "dropoutGapFactor", false, "float",
      "The relative depth threshold used to identify PSD dropouts for repair.");

  config.add(
      "extrapolation.dropoutMaxBins", "", "extrapolation.dropoutMaxBins",
...
int modalGainOpt::loadConfigImpl(mx::app::appConfigurator &_config) {
  ...
  std::string noiseEstimateDomain =
      extrapNoiseEstimateDomainName(m_extrapNoiseEstimateDomain);
  _config(noiseEstimateDomain, "extrapolation.noiseEstimateDomain");
  m_extrapNoiseEstimateDomain =
      extrapNoiseEstimateDomainFromName(noiseEstimateDomain);
  m_extrapConfig.m_noiseEstimateDomain =
      extrapNoiseEstimateDomainName(m_extrapNoiseEstimateDomain);
  std::string noiseEstimateRange =
      extrapNoiseEstimateRangeName(m_extrapNoiseEstimateRange);
  _config(noiseEstimateRange, "extrapolation.noiseEstimateRange");
  m_extrapNoiseEstimateRange =
      extrapNoiseEstimateRangeFromName(noiseEstimateRange);
  ...
  m_extrapNoiseEstimateStatistic =
      extrapNoiseEstimateStatisticFromName(noiseEstimateStatistic);
  m_extrapConfig.m_noiseEstimateStatistic =
      extrapNoiseEstimateStatisticName(m_extrapNoiseEstimateStatistic);
  _config(m_extrapConfig.m_noiseEstimateLowFreqMaxHz,
          "extrapolation.noiseEstimateLowFreqMaxHz");
  std::string closedLoopOlEstimateMethod =
      extrapClosedLoopOlEstimateMethodName(m_extrapClosedLoopOlEstimateMethod);
  _config(closedLoopOlEstimateMethod,
          "extrapolation.closedLoopOlEstimateMethod");
  m_extrapClosedLoopOlEstimateMethod =
      extrapClosedLoopOlEstimateMethodFromName(closedLoopOlEstimateMethod);
  ...
  _config(m_extrapConfig.m_powerLawMatchFreq,
          "extrapolation.powerLawMatchFreq");
  _config(m_extrapConfig.m_powerLawMatchFallbackWindowHz,
          "extrapolation.powerLawMatchFallbackWindowHz");
  std::string powerLawCrossoverMode =
      extrapPowerLawCrossoverModeName(m_extrapPowerLawCrossoverMode);
  _config(powerLawCrossoverMode, "extrapolation.powerLawCrossoverMode");
  m_extrapPowerLawCrossoverMode =
      extrapPowerLawCrossoverModeFromName(powerLawCrossoverMode);
  m_extrapConfig.m_powerLawCrossoverMode =
      extrapPowerLawCrossoverModeName(m_extrapPowerLawCrossoverMode);
  _config(m_extrapConfig.m_powerLawAutoSmoothWidthHz,
          "extrapolation.powerLawAutoSmoothWidthHz");
  _config(m_extrapConfig.m_fitPowerLawIndex, "extrapolation.fitPowerLawIndex");
  _config(m_extrapConfig.m_powerLawOnlyAboveFreq,
          "extrapolation.powerLawOnlyAboveFreq");
  _config(m_extrapConfig.m_powerLawFitIncludesMatchPoint,
          "extrapolation.powerLawFitIncludesMatchPoint");
  _config(m_extrapConfig.m_powerLawFitMinFreqHz,
          "extrapolation.powerLawFitMinFreqHz");
  _config(m_extrapConfig.m_powerLawFitMaxFreqHz,
          "extrapolation.powerLawFitMaxFreqHz");
  _config(m_extrapConfig.m_powerLawFitBinWidthHz,
          "extrapolation.powerLawFitBinWidthHz");
  _config(m_extrapConfig.m_powerLawBlendBins,
          "extrapolation.powerLawBlendBins");
  _config(m_extrapConfig.m_peakDetectWidthHz,
          "extrapolation.peakDetectWidthHz");
  _config(m_extrapConfig.m_peakDetectFactor, "extrapolation.peakDetectFactor");
  _config(m_extrapConfig.m_peakDetectBroadFactor,
          "extrapolation.peakDetectBroadFactor");
  _config(m_extrapConfig.m_peakDetectMinWidthLog,
...
void modalGainOpt::loadConfig() { loadConfigImpl(config); }
...
int modalGainOpt::appStartup() {
  ...
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_opticalGain, "opticalGain", 0, 1, 0.01,
                              "%0.01f", "Optical Gain", "Gain Opt.");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_gainGain, "gainGain", 0, 1, 0.01,
                              "%0.01f", "Gain Gain", "Gain Opt.");
  if (createStandardIndiSelectionSw(
          m_indiP_extrapMethod, "extrap_method",
          ...
          "Extrapolation Method", "Extrapolation") < 0) {
    log<software_error>({"error from createStandardIndiSelectionSw"});
    return -1;
  }
  if (registerIndiPropertyNew(m_indiP_extrapMethod,
                              INDI_NEWCALLBACK(m_indiP_extrapMethod)) < 0) {
    log<software_error>({"error from registerIndiPropertyNew"});
    return -1;
  }
  if (createStandardIndiSelectionSw(
          m_indiP_extrapNoiseEstimateDomain, "extrap_noiseEstimateDomain",
          ...
          {extrapNoiseEstimateDomainLabel(c_extrapNoiseEstimateOpenLoop),
           extrapNoiseEstimateDomainLabel(
               c_extrapNoiseEstimateClosedLoopPreXfer)},
          "Noise Estimate Domain", "Extrapolation") < 0) {
    log<software_error>({"error from createStandardIndiSelectionSw"});
    return -1;
  }
  ...
  if (createStandardIndiSelectionSw(
          m_indiP_extrapNoiseEstimateRange, "extrap_noiseEstimateRange",
          ...
          "Noise Estimate Range", "Extrapolation") < 0) {
    log<software_error>({"error from createStandardIndiSelectionSw"});
    return -1;
  }
  if (registerIndiPropertyNew(
  ...
  if (createStandardIndiSelectionSw(
          m_indiP_extrapNoiseEstimateStatistic, "extrap_noiseEstimateStatistic",
          ...
          "Noise Estimate Statistic", "Extrapolation") < 0) {
    log<software_error>({"error from createStandardIndiSelectionSw"});
    return -1;
  }
  if (registerIndiPropertyNew(
  ...
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapNoiseEstimateLowFreqMaxHz,
                              "extrap_noiseEstimateLowFreqMaxHz", 0, 10000, 0.1,
                              "%0.2f", "Noise Estimate Low-Freq Max",
                              "Extrapolation");
  if (createStandardIndiSelectionSw(m_indiP_extrapClosedLoopOlEstimateMethod,
  ...
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPowerLawIndex,
                              "extrap_powerLawIndex", 0, 10, 0.01, "%0.3f",
                              "Power-Law Index", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPowerLawNormFreq,
                              "extrap_powerLawNormFreq", 0, 10000, 0.1, "%0.2f",
                              "Power-Law Norm Freq", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPowerLawMatchFreq,
                              "extrap_powerLawMatchFreq", 0, 10000, 0.1,
                              "%0.2f", "Power-Law Match Freq", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPowerLawMatchFallbackWindowHz,
                              "extrap_powerLawMatchFallbackWindowHz", 0, 1000,
                              0.1, "%0.2f", "Power-Law Match Window",
                              "Extrapolation");
  if (createStandardIndiSelectionSw(
          m_indiP_extrapPowerLawCrossoverMode, "extrap_powerLawCrossoverMode",
          ...
          {extrapPowerLawCrossoverModeLabel(c_extrapPowerLawCrossoverManual),
           extrapPowerLawCrossoverModeLabel(
               c_extrapPowerLawCrossoverAutoSmoothedCrossing)},
          "Power-Law Crossover Mode", "Extrapolation") < 0) {
    log<software_error>({"error from createStandardIndiSelectionSw"});
    return -1;
  }
  if (registerIndiPropertyNew(
  ...
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPowerLawAutoSmoothWidthHz,
                              "extrap_powerLawAutoSmoothWidthHz", 0, 10000, 0.1,
                              "%0.2f", "Power-Law Auto Smooth Width",
                              "Extrapolation");
  if (createStandardIndiToggleSw(m_indiP_extrapFitPowerLawIndex,
                                 "extrap_fitPowerLawIndex",
                                 "Fit Power-Law Index", "Extrapolation") < 0) {
    log<software_error>({"error from createStandardIndiToggleSw"});
    return -1;
  }
  if (registerIndiPropertyNew(
          m_indiP_extrapFitPowerLawIndex,
          INDI_NEWCALLBACK(m_indiP_extrapFitPowerLawIndex)) < 0) {
    log<software_error>({"error from registerIndiPropertyNew"});
    return -1;
  }
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPowerLawOnlyAboveFreq,
                              "extrap_powerLawOnlyAboveFreq", 0, 10000, 0.1,
                              "%0.2f", "Power-Law Only Above", "Extrapolation");
  ...
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPowerLawFitMinFreqHz,
                              "extrap_powerLawFitMinFreqHz", 0, 10000, 0.1,
                              "%0.2f", "Fit Min Freq", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPowerLawFitMaxFreqHz,
                              "extrap_powerLawFitMaxFreqHz", 0, 10000, 0.1,
                              "%0.2f", "Fit Max Freq", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPowerLawFitBinWidthHz,
                              "extrap_powerLawFitBinWidthHz", 0, 10000, 0.1,
                              "%0.2f", "Fit Bin Width", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERI(m_indiP_extrapPowerLawBlendBins,
                              "extrap_powerLawBlendBins", 0, 100, 1, "%d",
                              "Blend Bins", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPeakDetectWidthHz,
                              "extrap_peakDetectWidthHz", 0, 10000, 0.1,
                              "%0.2f", "Peak Detect Width", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPeakDetectFactor,
                              "extrap_peakDetectFactor", 0, 100, 0.1, "%0.2f",
                              "Peak Detect Factor", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPeakDetectBroadFactor,
                              "extrap_peakDetectBroadFactor", 0, 100, 0.1,
                              "%0.2f", "Peak Broad Factor", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPeakDetectMinWidthLog,
                              "extrap_peakDetectMinWidthLog", 0, 10, 0.001,
                              "%0.4f", "Peak Min Width Log", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERI(m_indiP_extrapPeakDetectPasses,
                              "extrap_peakDetectPasses", 1, 100, 1, "%d",
                              "Peak Detect Passes", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapPeakMoffatBeta,
                              "extrap_peakMoffatBeta", 0, 100, 0.1, "%0.2f",
                              "Peak Moffat Beta", "Extrapolation");
  CREATE_REG_INDI_NEW_NUMBERF(m_indiP_extrapDropoutGapFactor,
                              "extrap_dropoutGapFactor", 0, 1, 0.01, "%0.3f",
                              "Dropout Gap Factor", "Extrapolation");
  ...
  CREATE_REG_INDI_RO_NUMBER(m_indiP_modesOn, "num_modes", "number of modes",
                            "Gain Opt.");
  indi::addNumberElement(m_indiP_modesOn, "current", 0, 2400, 1, "%d",
                         "Applied Modes");
  indi::addNumberElement(m_indiP_modesOn, "integrator", 0, 2400, 1, "%d",
                         "SI optimal");
  indi::addNumberElement(m_indiP_modesOn, "predictor", 0, 2400, 1, "%d",
                         "LP optimal");

  REG_INDI_SETPROP(m_indiP_opticalGainSource, m_opticalGainDevice,
                   m_opticalGainProperty);

  CREATE_REG_INDI_NEW_TOGGLESWITCH(m_indiP_opticalGainUpdate,
                                   "track_optical_gain");

  if (sem_init(&m_goptSemaphore, 0, 0) < 0) {
    return log<software_critical, -1>(
        {errno, 0, "Initializing gopt semaphore"});
  }
  m_goptSemaphoreInit = true;

  XWCAPP_THREAD_START(m_goptThread, m_goptThreadInit, m_goptThreadID,
                      m_goptThreadProp, m_goptThreadPrio, m_goptThreadCpuset,
                      "gainopt", goptThreadStart);
...
int modalGainOpt::appLogic() {
  ...
  if (autoUpdate) {
    updateSwitchIfChanged(m_indiP_autoUpdate, "toggle", pcf::IndiElement::On,
                          INDI_OK);
  } else {
    updateSwitchIfChanged(m_indiP_autoUpdate, "toggle", pcf::IndiElement::Off,
                          INDI_IDLE);
  }

  if (updateOnce) {
    updateSwitchIfChanged(m_indiP_updateOnce, "request", pcf::IndiElement::On,
                          INDI_OK);
  } else {
    updateSwitchIfChanged(m_indiP_updateOnce, "request", pcf::IndiElement::Off,
                          INDI_IDLE);
  }

  if (dump) {
    updateSwitchIfChanged(m_indiP_dump, "request", pcf::IndiElement::On,
                          INDI_OK);
  } else {
    updateSwitchIfChanged(m_indiP_dump, "request", pcf::IndiElement::Off,
                          INDI_IDLE);
  }

  if (opticalGainUpdate) {
    updateSwitchIfChanged(m_indiP_opticalGainUpdate, "toggle",
                          pcf::IndiElement::On, INDI_OK);
  } else {
    updateSwitchIfChanged(m_indiP_opticalGainUpdate, "toggle",
                          pcf::IndiElement::Off, INDI_IDLE);
  }

  updatesIfChanged<float>(m_indiP_opticalGain, {"current", "target"},
                          {opticalGain, opticalGain});

  updatesIfChanged<float>(m_indiP_gainGain, {"current", "target"},
                          {gainGain, gainGain});
  indi::updateSelectionSwitchIfChanged(m_indiP_extrapMethod,
                                       olProcessMethodElement(extrapOL),
                                       m_indiDriver, INDI_OK);
  indi::updateSelectionSwitchIfChanged(
      m_indiP_extrapNoiseEstimateDomain,
      extrapNoiseEstimateDomainElement(extrapNoiseEstimateDomain), m_indiDriver,
      INDI_OK);
  indi::updateSelectionSwitchIfChanged(
      m_indiP_extrapNoiseEstimateRange,
      extrapNoiseEstimateRangeElement(extrapNoiseEstimateRange), m_indiDriver,
      INDI_OK);
  indi::updateSelectionSwitchIfChanged(
      m_indiP_extrapNoiseEstimateStatistic,
  ...
  updatesIfChanged<float>(m_indiP_extrapNoiseEstimateLowFreqMaxHz,
                          {"current", "target"},
                          {extrapConfig.m_noiseEstimateLowFreqMaxHz,
                           extrapConfig.m_noiseEstimateLowFreqMaxHz});
  indi::updateSelectionSwitchIfChanged(
      m_indiP_extrapClosedLoopOlEstimateMethod,
  ...
  updatesIfChanged<float>(
      m_indiP_extrapPowerLawIndex, {"current", "target"},
      {extrapConfig.m_powerLawIndex, extrapConfig.m_powerLawIndex});
  updatesIfChanged<float>(
      m_indiP_extrapPowerLawNormFreq, {"current", "target"},
      {extrapConfig.m_powerLawNormFreq, extrapConfig.m_powerLawNormFreq});
  updatesIfChanged<float>(
      m_indiP_extrapPowerLawMatchFreq, {"current", "target"},
      {extrapConfig.m_powerLawMatchFreq, extrapConfig.m_powerLawMatchFreq});
  updatesIfChanged<float>(m_indiP_extrapPowerLawMatchFallbackWindowHz,
                          {"current", "target"},
                          {extrapConfig.m_powerLawMatchFallbackWindowHz,
                           extrapConfig.m_powerLawMatchFallbackWindowHz});
  indi::updateSelectionSwitchIfChanged(
      m_indiP_extrapPowerLawCrossoverMode,
  ...
  updatesIfChanged<float>(m_indiP_extrapPowerLawAutoSmoothWidthHz,
                          {"current", "target"},
                          {extrapConfig.m_powerLawAutoSmoothWidthHz,
                           extrapConfig.m_powerLawAutoSmoothWidthHz});
  updateSwitchIfChanged(m_indiP_extrapFitPowerLawIndex, "toggle",
                        extrapConfig.m_fitPowerLawIndex ? pcf::IndiElement::On
                                                        : pcf::IndiElement::Off,
                        INDI_OK);
  updatesIfChanged<float>(m_indiP_extrapPowerLawOnlyAboveFreq,
                          {"current", "target"},
                          {extrapConfig.m_powerLawOnlyAboveFreq,
                           extrapConfig.m_powerLawOnlyAboveFreq});
  updateSwitchIfChanged(m_indiP_extrapPowerLawFitIncludesMatchPoint, "toggle",
                        extrapConfig.m_powerLawFitIncludesMatchPoint
                            ? pcf::IndiElement::On
                            : pcf::IndiElement::Off,
                        INDI_OK);
  updatesIfChanged<float>(m_indiP_extrapPowerLawFitMinFreqHz,
                          {"current", "target"},
                          {extrapConfig.m_powerLawFitMinFreqHz,
                           extrapConfig.m_powerLawFitMinFreqHz});
  updatesIfChanged<float>(m_indiP_extrapPowerLawFitMaxFreqHz,
                          {"current", "target"},
                          {extrapConfig.m_powerLawFitMaxFreqHz,
                           extrapConfig.m_powerLawFitMaxFreqHz});
  updatesIfChanged<float>(m_indiP_extrapPowerLawFitBinWidthHz,
                          {"current", "target"},
                          {extrapConfig.m_powerLawFitBinWidthHz,
                           extrapConfig.m_powerLawFitBinWidthHz});
  updatesIfChanged<int>(
      m_indiP_extrapPowerLawBlendBins, {"current", "target"},
      {extrapConfig.m_powerLawBlendBins, extrapConfig.m_powerLawBlendBins});
  updatesIfChanged<float>(
      m_indiP_extrapPeakDetectWidthHz, {"current", "target"},
      {extrapConfig.m_peakDetectWidthHz, extrapConfig.m_peakDetectWidthHz});
  updatesIfChanged<float>(
      m_indiP_extrapPeakDetectFactor, {"current", "target"},
  ...
  updatesIfChanged<float>(m_indiP_extrapPeakDetectBroadFactor,
                          {"current", "target"},
                          {extrapConfig.m_peakDetectBroadFactor,
                           extrapConfig.m_peakDetectBroadFactor});
  updatesIfChanged<float>(m_indiP_extrapPeakDetectMinWidthLog,
                          {"current", "target"},
                          {extrapConfig.m_peakDetectMinWidthLog,
                           extrapConfig.m_peakDetectMinWidthLog});
  updatesIfChanged<int>(
      m_indiP_extrapPeakDetectPasses, {"current", "target"},
      {extrapConfig.m_peakDetectPasses, extrapConfig.m_peakDetectPasses});
  updatesIfChanged<float>(
      m_indiP_extrapPeakMoffatBeta, {"current", "target"},
      {extrapConfig.m_peakMoffatBeta, extrapConfig.m_peakMoffatBeta});
  updatesIfChanged<float>(
      m_indiP_extrapDropoutGapFactor, {"current", "target"},
...
int modalGainOpt::createImageStream(IMAGE *&stream, const std::string &name,
                                    uint32_t size0, uint32_t size1,
                                    uint32_t size2, uint8_t dataType) {
  ...
  if (ImageStreamIO_createIm_gpu(stream, name.c_str(), 3, imsize, dataType, -1,
                                 1, IMAGE_NB_SEMAPHORE, 0,
                                 CIRCULAR_BUFFER | ZAXIS_TEMPORAL, 0) != 0) {
    free(stream);
    stream = nullptr;
...
void modalGainOpt::writePublishedGainArrays(float *currentData, float *siData,
                                            float *maxSiData, float *lpData,
                                            float *maxLpData,
                                            float *modeVarData) {
  ...
  for (size_t n = 0; n < m_optGainSI.size(); ++n) {
    ...
    maxSiData[n] =
        (m_gainCalFacts[n] * m_gmaxSI[n] / m_gainCals[n]) / m_opticalGain;

    lpData[n] =
        (m_gainCalFacts[n] * m_optGainLP[n] / m_gainCals[n]) / m_opticalGain;
    maxLpData[n] =
        (m_gainCalFacts[n] * m_gmaxLP[n] / m_gainCals[n]) / m_opticalGain;
...
void modalGainOpt::writePublishedPredictorArrays(float *pcGainData,
                                                 float *aCoeffData,
                                                 uint32_t aWidth,
                                                 float *bCoeffData,
                                                 uint32_t bWidth, bool blend) {
    ...
    for (uint32_t k = 0; k < m_Na[n]; ++k) {
      if (blend) {
        aCoeffData[aBase + 1 + k] =
            aCoeffData[aBase + 1 + k] +
            m_gainGain * (m_goptLP[n].a()[k] - aCoeffData[aBase + 1 + k]);
      } else {
    ...
    for (uint32_t k = 0; k < m_Nb[n]; ++k) {
      if (blend) {
        bCoeffData[bBase + 1 + k] =
            bCoeffData[bBase + 1 + k] +
            m_gainGain * (m_goptLP[n].b()[k] - bCoeffData[bBase + 1 + k]);
      } else {
...
int modalGainOpt::countEnabledGainFactors(
    const std::vector<float> &gainFacts) const {
  int modesOn = 0;
...
void modalGainOpt::updateAppliedModeCount(const std::vector<float> &gainFacts,
                                          bool predictorPath) {
...
bool modalGainOpt::applyGainFactorUpdate(std::vector<float> &gainFacts,
                                         const float *incoming, uint32_t width,
                                         bool predictorPath) {
  bool change = false;
...
bool modalGainOpt::refreshGoptStructures() {
  if (!(m_goptUpdated || m_pcgoptUpdated || m_freqUpdated ||
        m_goptCurrent.size() != m_gainFacts.size())) {
    return false;
  }
...
int modalGainOpt::allocatePCShmims() {
  ...
  if (numpccoeffShmimMonitorT::m_smState != dev::shmimMonitorState::connected ||
      numpccoeffShmimMonitorT::m_width != m_nModes ||
      numpccoeffShmimMonitorT::m_height != 2) {
    mx::improc::eigenImage<uint32_t> Npc(m_nModes, 2);
    Npc.setConstant(m_defaultNCoeff);

    if (numpccoeffShmimMonitorT::create(m_nModes, 2, 1, _DATATYPE_UINT32,
                                        Npc.data()) != 0) {
  ...
  if (acoeffShmimMonitorT::m_smState != dev::shmimMonitorState::connected ||
      acoeffShmimMonitorT::m_width != m_maxNCoeff + 1 ||
      acoeffShmimMonitorT::m_height != m_nModes) {
    if (acoeffShmimMonitorT::create(m_maxNCoeff + 1, m_nModes, 1,
                                    _DATATYPE_FLOAT) != 0) {
  ...
  if (bcoeffShmimMonitorT::m_smState != dev::shmimMonitorState::connected ||
      bcoeffShmimMonitorT::m_width != m_maxNCoeff ||
      bcoeffShmimMonitorT::m_height != m_nModes) {
    if (bcoeffShmimMonitorT::create(m_maxNCoeff + 1, m_nModes, 1,
                                    _DATATYPE_FLOAT) != 0) {
  ...
  if (pcGainFactShmimMonitorT::m_smState != dev::shmimMonitorState::connected ||
      pcGainFactShmimMonitorT::m_width != m_nModes ||
      pcGainFactShmimMonitorT::m_height != 1) {
  ...
  if (pcMultFactShmimMonitorT::m_smState != dev::shmimMonitorState::connected ||
      pcMultFactShmimMonitorT::m_width != m_nModes ||
      pcMultFactShmimMonitorT::m_height != 1) {
...
int modalGainOpt::allocate(const psdShmimT &dummy) {
  ...
  if (m_olPSDStream != nullptr && (m_olPSDStream->md->size[0] != m_nFreq ||
                                   m_olPSDStream->md->size[1] != m_nModes)) {
    destroyImageStream(m_olPSDStream);
    destroyImageStream(m_rawOlPSDStream);
    destroyImageStream(m_smoothOlPSDStream);
    destroyImageStream(m_noisePSDStream);
  ...
  if (m_olPSDStream == nullptr) {
    if (createImageStream(m_olPSDStream, m_olPSDShmimName, m_nFreq, m_nModes, 1,
                          psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_rawOlPSDStream, m_rawOlPSDShmimName, m_nFreq,
                          m_nModes, 1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_smoothOlPSDStream, m_smoothOlPSDShmimName, m_nFreq,
                          m_nModes, 1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_noisePSDStream, m_noisePSDShmimName, m_nFreq,
                          m_nModes, 1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_clXferCurrentStream, m_clXferCurrentShmimName,
                          m_nFreq, m_nModes, 1,
                          psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_clNtfCurrentStream, m_clNtfCurrentShmimName,
                          m_nFreq, m_nModes, 1,
                          psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_clXferSIStream, m_clXferSIShmimName, m_nFreq,
                          m_nModes, 1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_clNtfSIStream, m_clNtfSIShmimName, m_nFreq,
                          m_nModes, 1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_clXferLPStream, m_clXferLPShmimName, m_nFreq,
                          m_nModes, 1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_clNtfLPStream, m_clNtfLPShmimName, m_nFreq,
                          m_nModes, 1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }
  }
  ...
  if (m_optGainStream != nullptr &&
      (m_optGainStream->md->size[0] != psdShmimMonitorT::m_height ||
       m_optGainStream->md->size[1] != 1)) {
    destroyImageStream(m_optGainStream);
    destroyImageStream(m_optGainSIStream);
    destroyImageStream(m_maxGainSIStream);
    destroyImageStream(m_optGainLPStream);
  ...
  if (m_optGainStream == nullptr) {
    if (createImageStream(m_optGainStream, m_optGainShmimName, m_nModes, 1, 1,
                          psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_optGainSIStream, m_optGainSIShmimName, m_nModes, 1,
                          1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_maxGainSIStream, m_maxGainSIShmimName, m_nModes, 1,
                          1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_optGainLPStream, m_optGainLPShmimName, m_nModes, 1,
                          1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_maxGainLPStream, m_maxGainLPShmimName, m_nModes, 1,
                          1, psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }

    if (createImageStream(m_modevarStream, m_modevarShmimName, 3, m_nModes, 1,
                          psdShmimMonitorT::m_dataType) < 0) {
      return -1;
    }
  }
...
int modalGainOpt::processImage(void *curr_src, const psdShmimT &dummy) {
  ...
  if (m_psdAvgTime <= 0 ||
      m_psdTime <=
          0) // Safety check, shouldn't happen but means we need to wait.
  {
    return 0;
  }
  ...
  m_clPSDs = Eigen::Map<Eigen::Array<float, -1, -1>>(
      static_cast<float *>(curr_src), psdShmimMonitorT::m_width,
...
int modalGainOpt::processImage(void *curr_src, const numpccoeffShmimT &dummy) {
  ...
  if (w != m_Na.size() || w != m_Nb.size() || w != m_regCounter.size() ||
      w != m_regScale.size()) {
    m_updating = true;
    lock.lock();
    m_updating = true; // Make sure it didn't get set to false by thread that
  ...
  mx::improc::eigenMap<uint32_t> Npc(reinterpret_cast<uint32_t *>(curr_src), w,
                                     2);
...
int modalGainOpt::processImage(void *curr_src, const noiseShmimT &dummy) {
  ...
  for (uint32_t n = 0; n < h; ++n) {
    if (change || m_noiseParams(0, n) != np(0, n) ||
        m_noiseParams(1, n) != np(1, n) || m_noiseParams(2, n) != np(2, n)) {
      if (!change) {
        m_updating = true;
        lock.lock();
        m_updating = true; // Make sure it didn't get set to false by thread
  ...
  if (change) {
    ...
    m_updating = false;
    m_goptUpdated = true;
    std::cerr << "got noise params: " << m_noiseParams.rows() << " x "
              << m_noiseParams.cols() << "\n";
    lock.unlock();
  }
  return 0;
...
int modalGainOpt::allocate(const wfsavgShmimT &dummy) {
  ...
  std::cerr << "Got WFS avg: " << wfsavgShmimMonitorT::m_width << " x "
...
int modalGainOpt::processImage(void *curr_src, const wfsavgShmimT &dummy) {
  ...
  { // mutex scope
    ...
    if (m_wfsavg.rows() == m_wfsmask.rows() &&
        m_wfsavg.cols() == m_wfsmask.cols()) {
...
int modalGainOpt::allocate(const wfsmaskShmimT &dummy) {
  ...
  std::cerr << "Got WFS mask: " << wfsmaskShmimMonitorT::m_width << " x "
...
int modalGainOpt::checkSizes() {
  ...
  int L = 0;
  if (m_clPSDs.rows() == 0 ||
      m_clPSDs.cols() == 0) // somehow here without any data
  {
    if (!logged[L]) {
  ...
  if (m_Na.size() != m_nModes || m_NaCurrent.size() != m_nModes ||
      (size_t)m_as.cols() != m_nModes || m_Nb.size() != m_nModes ||
      m_NbCurrent.size() != m_nModes || (size_t)m_bs.cols() != m_nModes ||
...
void modalGainOpt::goptThreadStart(modalGainOpt *p) { p->goptThreadExec(); }
...
#pragma omp parallel for num_threads(15)
      for (size_t n = 0; n < m_goptCurrent.size(); ++n) {
        ...
        if (!m_pcOn) {
          MGO_BREADCRUMB;
          float currGain =
              m_gain * m_gainFacts[n] * m_gainCals[n] * m_opticalGain;

          for (size_t f = 0; f < m_goptCurrent[n].f_size(); ++f) {
            m_goptCurrent[n].clTF2(m_clXferCurrent(f, n), m_clNtfCurrent(f, n),
                                   f, currGain);
          }
        } else {
          float currGain =
              m_pcGain * m_pcGainFacts[n] * m_gainCals[n] * m_opticalGain;
          for (size_t f = 0; f < m_goptCurrent[n].f_size(); ++f) {
            m_goptCurrent[n].clTF2(m_clXferCurrent(f, n), m_clNtfCurrent(f, n),
                                   f, currGain);
          }
        ...
        if (useNtfAwareClosedLoopEstimate) {
          ...
          for (size_t f = 0; f < clMeasuredPsd.size(); ++f) {
            noiseEstimateWorkPsd[f] =
                clMeasuredPsd[f] / std::max(ntfCorrectionPsd[f], tiny);
          }
...
#pragma omp critical
        ...
        if (m_extrapOL == c_olProcessNone) {
          float noiseFloor = 0;
          mx::error_t errc = processPsdProcessorT::estimateNoisePsd(
              m_nPSDs[n], noiseFloor, *noiseEstimateSourcePsd, m_freq, n,
              m_extrapConfig.m_noiseEstimateRange,
              m_extrapConfig.m_noiseEstimateStatistic,
              m_extrapConfig.m_noiseEstimateLowFreqMaxHz);
          if (!!errc) {
#pragma omp critical
          ...
          if (useClosedLoopNoiseEstimate) {
            ...
            for (size_t f = 1; f < m_goptCurrent[n].f_size(); ++f) {
              ...
              m_olPSDs[n][f] =
                  std::max(clMeasuredPsd[f] - closedLoopNoise, tiny) /
          ...
          const std::vector<float> &processMeasuredPsd =
              useClosedLoopNoiseEstimate ? clMeasuredPsd : m_olPSDs[n];
          const std::vector<float> *processEtfPsd =
              useClosedLoopNoiseEstimate ? &etfCorrectionPsd : nullptr;
          const std::vector<float> *processNtfPsd =
              useClosedLoopNoiseEstimate ? &ntfCorrectionPsd : nullptr;
          mx::error_t errc = processPsdProcessorT::analyzePsd(
              processResult, processMeasuredPsd, m_freq, n, processConfig, 0,
              processPsdProcessorT::c_defaultLpContinuumWidthHz, processEtfPsd,
              processNtfPsd);
          if (!!errc) {
#pragma omp critical
            {
              ...
              log<text_log>(
                  "extrapolation settings: noiseDomain=" +
                      processConfig.m_noiseEstimateDomain + " noiseRange=" +
                      processConfig.m_noiseEstimateRange + " noiseStatistic=" +
                      processConfig.m_noiseEstimateStatistic + " noiseLowMax=" +
                      std::to_string(
                          processConfig.m_noiseEstimateLowFreqMaxHz) +
                      " olEstimateMethod=" +
                      processConfig.m_closedLoopOlEstimateMethod + " match=" +
                      std::to_string(processConfig.m_powerLawMatchFreq) +
                      " matchWindow=" +
                      std::to_string(
                          processConfig.m_powerLawMatchFallbackWindowHz) +
                      " crossoverMode=" +
                      processConfig.m_powerLawCrossoverMode + " autoSmooth=" +
                      std::to_string(
                          processConfig.m_powerLawAutoSmoothWidthHz) +
                      " fitIndex=" +
                      std::string(processConfig.m_fitPowerLawIndex ? "true"
                                                                   : "false") +
                      " fitMin=" +
                      std::to_string(processConfig.m_powerLawFitMinFreqHz) +
                      " fitMax=" +
                      std::to_string(processConfig.m_powerLawFitMaxFreqHz) +
                      " fitBin=" +
                      std::to_string(processConfig.m_powerLawFitBinWidthHz) +
                      " blendBins=" +
                      std::to_string(processConfig.m_powerLawBlendBins) +
                      " peakWidth=" +
                      std::to_string(processConfig.m_peakDetectWidthHz) +
                      " peakFactor=" +
                      std::to_string(processConfig.m_peakDetectFactor) +
                      " peakBroadFactor=" +
                      std::to_string(processConfig.m_peakDetectBroadFactor) +
                      " peakMinWidthLog=" +
                      std::to_string(processConfig.m_peakDetectMinWidthLog) +
                      " peakPasses=" +
                      std::to_string(processConfig.m_peakDetectPasses) +
                      " peakBeta=" +
                      std::to_string(processConfig.m_peakMoffatBeta) +
                      " dropoutGap=" +
                      std::to_string(processConfig.m_dropoutGapFactor) +
                      " dropoutMaxBins=" +
                      std::to_string(processConfig.m_dropoutMaxBins) +
                      " powerLawOnlyAbove=" +
                      std::to_string(processConfig.m_powerLawOnlyAboveFreq),
                  logPrio::LOG_NOTICE);
            }

            float noiseFloor = 0;
            mx::error_t noiseErr = processPsdProcessorT::estimateNoisePsd(
                m_nPSDs[n], noiseFloor, *noiseEstimateSourcePsd, m_freq, n,
                processConfig.m_noiseEstimateRange,
                processConfig.m_noiseEstimateStatistic,
                processConfig.m_noiseEstimateLowFreqMaxHz);
...
#pragma omp critical
          ...
          m_optGainSI[n] = m_goptSI[n].optGainOpenLoop(
              m_modeVarSI[n], m_olPSDs[n], m_nPSDs[n], m_gmaxSI[n], false);
...
#pragma omp critical
            ...
            MGO_BREADCRUMB;
            for (size_t f = 0; f < m_goptCurrent[n].f_size(); ++f) {
              m_goptSI[n].clTF2(m_clXferSI(f, n), m_clNtfSI(f, n), f,
                                m_optGainSI[n]);
            }
        ...
        if (m_doPCCalcs && !flagOff) {
          ...
          if (m_regScale[n] == -999 || m_regCounter[n] >= m_nRegCycles) {
            ...
            if (m_linPred[n].regularizeCoefficients(
                    gmax_lp, m_optGainLP[n], m_modeVarLP[n], min_sc,
                    m_goptLP[n], lpProcessPsd, m_nPSDs[n], m_Na[n]) < 0) {
              MGO_BREADCRUMB;
            ...
            if (m_linPred[n].calcCoefficients(
                    lpProcessPsd, m_nPSDs[n],
                    psdReg * pow(10, -m_regScale[n] / 10), m_Na[n]) < 0) {
              m_optGainLP[n] = 0;
              m_modeVarLP[n] = m_modeVarOL[n];
...
#pragma omp critical
            ...
            MGO_BREADCRUMB;
            for (size_t f = 0; f < m_goptCurrent[n].f_size(); ++f) {
              m_goptLP[n].clTF2(m_clXferLP(f, n), m_clNtfLP(f, n), f,
                                m_optGainLP[n]);
            }
...
#pragma omp critical
      ...
      mx::improc::eigenMap<float> mvs(m_modevarStream->array.F, 3,
                                      m_modeVarSI.size());
      ...
      if (m_autoUpdate || m_updateOnce || m_dump) {
        ...
        if (m_dump) {
          ...
          for (size_t n = 0; n < m_nModes; ++n) {
            // if( m_timesOnSI[n] > 5 )
            {
              f[n] = f[n] + m_gainGain * ((m_gainCalFacts[n] * m_optGainSI[n] /
                                           m_gainCals[n]) /
                                              m_opticalGain -
                                          f[n]);
            }
        ...
        if (m_doPCCalcs) {
          ...
          writePublishedPredictorArrays(fpc, fa, acoeffShmimMonitorT::m_width,
                                        fb, bcoeffShmimMonitorT::m_width,
                                        !m_dump);
      ...
      for (size_t q = 0; q < m_olPSDs.size(); ++q) {
        memcpy(m_olPSDStream->array.F + q * m_olPSDs[0].size(),
               m_olPSDs[q].data(), m_olPSDs[0].size() * sizeof(float));
        memcpy(m_rawOlPSDStream->array.F + q * m_rawOlPSDs[0].size(),
               m_rawOlPSDs[q].data(), m_rawOlPSDs[0].size() * sizeof(float));
        ...
        memcpy(m_noisePSDStream->array.F + q * m_nPSDs[0].size(),
               m_nPSDs[q].data(), m_nPSDs[0].size() * sizeof(float));
      }

      memcpy(m_clXferCurrentStream->array.F, m_clXferCurrent.data(),
             m_clXferCurrent.rows() * m_clXferCurrent.cols() * sizeof(float));
      memcpy(m_clNtfCurrentStream->array.F, m_clNtfCurrent.data(),
             m_clNtfCurrent.rows() * m_clNtfCurrent.cols() * sizeof(float));
      memcpy(m_clXferSIStream->array.F, m_clXferSI.data(),
             m_clXferSI.rows() * m_clXferSI.cols() * sizeof(float));
      memcpy(m_clNtfSIStream->array.F, m_clNtfSI.data(),
             m_clNtfSI.rows() * m_clNtfSI.cols() * sizeof(float));
      memcpy(m_clXferLPStream->array.F, m_clXferLP.data(),
             m_clXferLP.rows() * m_clXferLP.cols() * sizeof(float));
      memcpy(m_clNtfLPStream->array.F, m_clNtfLP.data(),
             m_clNtfLP.rows() * m_clNtfLP.cols() * sizeof(float));
...
int modalGainOpt::handleExtrapMethodProperty(const pcf::IndiProperty &ipRecv) {
  ...
  bool found = false;
  for (auto elit = ipRecv.getElements().begin();
       elit != ipRecv.getElements().end(); ++elit) {
    ...
    if (target == c_olProcessNone &&
        elit->first != olProcessMethodElement(c_olProcessNone)) {
      return log<software_error, -1>(
  ...
  if (!found) {
    ...
    if (m_indiP_extrapMethod.find(currentElement)) {
      for (auto elit = m_indiP_extrapMethod.getElements().begin();
           elit != m_indiP_extrapMethod.getElements().end(); ++elit) {
        m_indiP_extrapMethod[elit->first].setSwitchState(
            elit->first == currentElement ? pcf::IndiElement::On
                                          : pcf::IndiElement::Off);
      }
      m_indiP_extrapMethod.setState(pcf::IndiProperty::Ok);
    }

    indi::updateSelectionSwitchIfChanged(m_indiP_extrapMethod, currentElement,
                                         m_indiDriver, INDI_OK);
    return 0;
  }
...
int modalGainOpt::handleExtrapNoiseEstimateDomainProperty(
    const pcf::IndiProperty &ipRecv) {
  ...
  if (!found) {
    ...
    const std::string currentElement =
        extrapNoiseEstimateDomainElement(current);
    ...
    indi::updateSelectionSwitchIfChanged(m_indiP_extrapNoiseEstimateDomain,
                                         currentElement, m_indiDriver, INDI_OK);
    return 0;
  }
  ...
  if (target != m_extrapNoiseEstimateDomain) {
    ...
    m_extrapConfig.m_noiseEstimateDomain =
        extrapNoiseEstimateDomainName(target);

    m_sinceChange = -1;
    m_updating = false;
    std::cerr << "Got noise-estimate domain: "
              << extrapNoiseEstimateDomainName(target) << '\n';
  }
...
int modalGainOpt::handleExtrapNoiseEstimateRangeProperty(
    const pcf::IndiProperty &ipRecv) {
  ...
  if (target != m_extrapNoiseEstimateRange) {
    ...
    m_sinceChange = -1;
    m_updating = false;
    std::cerr << "Got noise-estimate range: "
              << extrapNoiseEstimateRangeName(target) << '\n';
  }

  return 0;
}

int modalGainOpt::handleExtrapNoiseEstimateStatisticProperty(
    const pcf::IndiProperty &ipRecv) {
  ...
  for (auto elit = ipRecv.getElements().begin();
    ...
    if (target == c_extrapNoiseEstimatePercentile &&
        elit->first != extrapNoiseEstimateStatisticElement(
  ...
  if (!found) {
    ...
    const std::string currentElement =
        extrapNoiseEstimateStatisticElement(current);
    if (m_indiP_extrapNoiseEstimateStatistic.find(currentElement)) {
      for (auto elit =
               m_indiP_extrapNoiseEstimateStatistic.getElements().begin();
  ...
  if (target != m_extrapNoiseEstimateStatistic) {
    ...
    m_extrapConfig.m_noiseEstimateStatistic =
        extrapNoiseEstimateStatisticName(target);

    m_sinceChange = -1;
    m_updating = false;
    std::cerr << "Got noise-estimate statistic: "
              << extrapNoiseEstimateStatisticName(target) << '\n';
  }
...
int modalGainOpt::handleExtrapClosedLoopOlEstimateMethodProperty(
    const pcf::IndiProperty &ipRecv) {
  ...
  for (auto elit = ipRecv.getElements().begin();
    ...
    if (target == c_extrapClosedLoopOlEstimateEtfOnly &&
        elit->first != extrapClosedLoopOlEstimateMethodElement(
                           c_extrapClosedLoopOlEstimateEtfOnly)) {
      return log<software_error, -1>(
  ...
  if (!found) {
    ...
    const std::string currentElement =
        extrapClosedLoopOlEstimateMethodElement(current);
    if (m_indiP_extrapClosedLoopOlEstimateMethod.find(currentElement)) {
      for (auto elit =
               m_indiP_extrapClosedLoopOlEstimateMethod.getElements().begin();
    ...
    indi::updateSelectionSwitchIfChanged(
        m_indiP_extrapClosedLoopOlEstimateMethod, currentElement, m_indiDriver,
        INDI_OK);
    return 0;
  }
  ...
  if (target != m_extrapClosedLoopOlEstimateMethod) {
    ...
    m_extrapConfig.m_closedLoopOlEstimateMethod =
        extrapClosedLoopOlEstimateMethodName(target);

    m_sinceChange = -1;
    m_updating = false;
    std::cerr << "Got closed-loop OL estimate method: "
              << extrapClosedLoopOlEstimateMethodName(target) << '\n';
  }
...
int modalGainOpt::handleExtrapPowerLawCrossoverModeProperty(
    const pcf::IndiProperty &ipRecv) {
  ...
  for (auto elit = ipRecv.getElements().begin();
    ...
    if (target == c_extrapPowerLawCrossoverManual &&
        elit->first != extrapPowerLawCrossoverModeElement(
                           c_extrapPowerLawCrossoverManual)) {
      return log<software_error, -1>(
          {"Invalid power-law-crossover-mode element: " + elit->first});
    }
  ...
  if (!found) {
    ...
    const std::string currentElement =
        extrapPowerLawCrossoverModeElement(current);
    if (m_indiP_extrapPowerLawCrossoverMode.find(currentElement)) {
      for (auto elit =
               m_indiP_extrapPowerLawCrossoverMode.getElements().begin();
  ...
  if (target != m_extrapPowerLawCrossoverMode) {
    ...
    m_extrapConfig.m_powerLawCrossoverMode =
        extrapPowerLawCrossoverModeName(target);

    m_sinceChange = -1;
    m_updating = false;
    std::cerr << "Got power-law crossover mode: "
              << extrapPowerLawCrossoverModeName(target) << '\n';
  }
...
(const pcf::IndiProperty &ipRecv) {
  INDI_VALIDATE_CALLBACK_PROPS(m_indiP_extrapClosedLoopOlEstimateMethod,
                               ipRecv);
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPowerLawIndex,
                                    m_extrapConfig.m_powerLawIndex, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPowerLawNormFreq,
                                    m_extrapConfig.m_powerLawNormFreq, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPowerLawMatchFreq,
                                    m_extrapConfig.m_powerLawMatchFreq, ipRecv,
                                    "extrap power-law match freq");
}

INDI_NEWCALLBACK_DEFN(modalGainOpt, m_indiP_extrapPowerLawMatchFallbackWindowHz)
(const pcf::IndiProperty &ipRecv) {
  INDI_VALIDATE_CALLBACK_PROPS(m_indiP_extrapPowerLawMatchFallbackWindowHz,
                               ipRecv);
  return handleExtrapNumberProperty(
      m_indiP_extrapPowerLawMatchFallbackWindowHz,
      m_extrapConfig.m_powerLawMatchFallbackWindowHz, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapToggleProperty(m_indiP_extrapFitPowerLawIndex,
                                    m_extrapConfig.m_fitPowerLawIndex, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPowerLawOnlyAboveFreq,
                                    ...
                                    ipRecv, "extrap power-law only above freq");
}

INDI_NEWCALLBACK_DEFN(modalGainOpt, m_indiP_extrapPowerLawFitIncludesMatchPoint)
(const pcf::IndiProperty &ipRecv) {
  INDI_VALIDATE_CALLBACK_PROPS(m_indiP_extrapPowerLawFitIncludesMatchPoint,
                               ipRecv);
  return handleExtrapToggleProperty(
      m_indiP_extrapPowerLawFitIncludesMatchPoint,
      m_extrapConfig.m_powerLawFitIncludesMatchPoint, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPowerLawBlendBins,
                                    m_extrapConfig.m_powerLawBlendBins, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPeakDetectWidthHz,
                                    m_extrapConfig.m_peakDetectWidthHz, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPeakDetectFactor,
                                    m_extrapConfig.m_peakDetectFactor, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPeakDetectBroadFactor,
                                    ...
                                    ipRecv, "extrap peak detect broad factor");
}
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPeakDetectMinWidthLog,
                                    ...
                                    ipRecv, "extrap peak detect min width log");
}
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPeakDetectPasses,
                                    m_extrapConfig.m_peakDetectPasses, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapPeakMoffatBeta,
                                    m_extrapConfig.m_peakMoffatBeta, ipRecv,
...
(const pcf::IndiProperty &ipRecv) {
  ...
  return handleExtrapNumberProperty(m_indiP_extrapDropoutGapFactor,
                                    m_extrapConfig.m_dropoutGapFactor, ipRecv,
