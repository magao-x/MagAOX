...
adcTracker::adcTracker() : MagAOXApp(MAGAOX_GIT_SHA1, MAGAOX_GIT_MODIFIED, MAGAOX_GIT_URL, MAGAOX_GIT_BRANCH, MAGAOX_SOURCE_PATH, MAGAOX_GIT_UNTRACKED)
{
...
int adcTracker::appStartup()
{
   ...
   if(mx::ioutils::readColumns<mx::ioutils::readColCommaDelim>(luppath, m_lupZD, m_lupADC1, m_lupADC2) != mx::error_t::noerror)
   {
