...
void statusCombo::on_buttonGo_pressed()
{
    ...
    {
        std::cerr << "statusCombo::on_buttonGo_pressed suppressed already-active selection " << m_device << "."
                  << m_property << " selection=" << selection << "\n";
        return;
    }

    if( m_statusCommandPending && selection == m_statusRequested )
    {
        std::cerr << "statusCombo::on_buttonGo_pressed suppressed duplicate pending selection " << m_device << "."
                  << m_property << " selection=" << selection << "\n";
        return;
    }
