...
#define aMTMDAQ2_MODULE_BASE_ADDRESS                            10


#define aMTMDAQ2_NUM_APPS                                        4
#define aMTMDAQ2_NUM_POINTERS                                    4
#define aMTMDAQ2_NUM_STORES                                      2
#define   aMTMDAQ2_NUM_INTERNAL_SLOTS                           12
#define   aMTMDAQ2_NUM_RAM_SLOTS                                 1
#define aMTMDAQ2_NUM_TIMERS                                      8
#define aMTMDAQ2_NUM_DIGITALS                                    2
#define aMTMDAQ2_NUM_ANALOGS                                    18
#define   aMTMDAQ2_NUM_ANALOG_INPUTS                            16
#define   aMTMDAQ2_NUM_ANALOG_OUTPUTS                            2
#define aMTMDAQ2_NUM_I2C                                         1
...
public:
    ...
    AnalogClass analog[aMTMDAQ2_NUM_ANALOGS];
    AppClass app[aMTMDAQ2_NUM_APPS];
    DigitalClass digital[aMTMDAQ2_NUM_DIGITALS];
    I2CClass i2c[aMTMDAQ2_NUM_I2C];
    PointerClass pointer[aMTMDAQ2_NUM_POINTERS];
    StoreClass store[aMTMDAQ2_NUM_STORES];
    SystemClass system;
    TimerClass timer[aMTMDAQ2_NUM_TIMERS];
