...
///
/// Update: "sections" are now supported, these are a way of using a short name
...
/// [section1]
///
/// In this case, the full names of the entries in this section are:
///
/// section1.engine_number
/// section1.num_valves
/// section1.name
///
/// Note that the section name is separated from the variable name by a ".". The
/// section name must be surrounded by square brackets and must not contain
/// spaces. The section must be closed by listing the section name again at the
/// end of the list of variables, and it must match the first section name.
///
