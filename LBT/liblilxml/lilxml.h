...
extern void appXMLEle (XMLEle *ep, XMLEle *newep);
...
extern XMLEle *getXMLEle (LilXML *lp);
extern LilXML *cloneLilXML (LilXML *lp);




/* install alternatives to malloc/realloc/free */
extern void lilxmlMalloc (void *(*newmalloc)(size_t size),
